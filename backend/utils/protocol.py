def get_localized_steps(lang: str = "en", business_type: str = "Business"):
    ...
    step12_labels = {
        "en": "Submit Municipality & Food Permit Forms" if is_food else "Submit Municipality & Local Permit Forms",
        "tr": "Belediye ve Gıda İzni Formlarını Sun" if is_food else "Belediye ve Yerel İzin Formlarını Sun",
        "ar": "تقديم نماذج تصاريح البلدية والأغذية" if is_food else "تقديم نماذج تصاريح البلدية والتصاريح المحلية"
    }
    
    step12_title = step12_labels.get(lang, step12_labels["en"])
    ...
    specs_map = {
        "en": [
            ...
            (4, "Select Business Activity (NACE code)", "Agent", "Choose appropriate NACE category (e.g., Retail, Food, Service). Selected in MERSİS."),
            (5, "Generate Articles of Association", "Agent", "MERSİS auto-generates based on type, shareholders, and capital."),
            (6, "Prepare Company Address", "Human", "Rent office/shop/facility or use virtual office. Must be verifiable for tax inspection."),
            ...
            (12, step12_title, "Agent", "Use e-Devlet / municipal portal to submit applications online. Physical inspections by municipal authorities remain Human."),
            (13, "Hire Accountant & Register Employees", "Human", "Certified accountant required; register employees with SGK (social security)."),
            (14, "Start Business Operations", "Human", "Open your store/office/facility after all permits approved.")
        ],
        "tr": [
            ...
            (4, "İş Faaliyetini Seç (NACE kodu)", "Ajan", "Uygun NACE kategorisini seçin (Örn: Perakende, Gıda, Hizmet). MERSİS'te seçilir."),
            (5, "Ana Sözleşmeyi Oluştur", "Ajan", "MERSİS; tür, hissedarlar ve sermayeye göre otomatik oluşturur."),
            (6, "Şirket Adresini Hazırla", "İnsan", "Ofis/dükkan/tesis kiralayın veya sanal ofis kullanın. Vergi denetimi için doğrulanabilir olmalıdır."),
            ...
            (12, step12_title, "Ajan", "Başvuruları online yapmak için e-Devlet / belediye portalını kullanın. Fiziksel denetimler insan tarafından yapılır."),
            (13, "Muhasebeci Tut ve Çalışanları Kaydet", "İnsan", "Sertifikalı muhasebeci zorunludur; çalışanları SGK'ya kaydedin."),
            (14, "Ticari Faaliyetlere Başla", "İnsan", "Tüm izinler onaylandıktan sonra dükkan/ofis/tesisinizi açın.")
        ],
        "ar": [
            ...
            (4, "اختيار نشاط العمل (كود NACE)", "وكيل", "اختر فئة NACE المناسبة (مثل البيع بالتجزئة أو الغذاء أو الخدمة). يتم اختياره في MERSİS."),
            (5, "إنشاء النظام الأساسي للشركة", "وكيل", "يقوم MERSİS بإنشائه تلقائياً بناءً على النوع والمساهمين ورأس المال."),
            (6, "إعداد عنوان الشركة", "بشري", "استئجار مكتب/محل/منشأة أو استخدام مكتب افتراضي. يجب أن يكون قابلاً للتحقق لتفتيش الضرائب."),
            ...
            (12, step12_title, "وكيل", "استخدم بوابة e-Devlet / البلدية لتقديم الطلبات عبر الإنترنت. تفتيشات البلدية تظل بشرية."),
            (13, "تعيين محاسب وتسجيل الموظفين", "بشري", "مطلوب محاسب معتمد؛ تسجيل الموظفين في SGK (التأمينات الاجتماعية)."),
            (14, "بدء عمليات العمل", "بشري", "فتح المحل/المكتب/المنشأة بعد الموافقة على جميع التصاريح.")
        ]
    }
