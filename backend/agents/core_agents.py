...
2. Once you have the Business Type and Location (any Istanbul district), return a CombinedPermitResult with:
   - Location: The specific district in Istanbul (e.g. Kadıköy, Şişli).
   - Business Type: The type of business (e.g. Cafe, Restaurant, Bakery).
   - Permits & Agencies: List them concisely (Label: Agency). Include the specific District Municipality if known.
